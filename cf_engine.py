...
_CF_LINE_SECTION_FIX = {
    ...
    # '회생채무의 상환' / '신종자본증권 거래원가' → Ⅲ-2 재무활동 현금유출액
    # (형제 코드 CF6220001~007 은 모두 Ⅲ-2 인데 이 둘만 Ⅰ-4 로 잘못 분류돼 있었음)
    'CF6220008': ('Ⅲ-2',
                  'Ⅲ. 재무활동으로 인한 현금흐름 > 2. 재무활동으로 인한 현금유출액', '-'),
    'CF6220009': ('Ⅲ-2',
                  'Ⅲ. 재무활동으로 인한 현금흐름 > 2. 재무활동으로 인한 현금유출액', '-'),
    # CF71000xx '기타' 계열 나머지 — 이름이 곧 소속 섹션인데 전부 Ⅰ-4 로 몰려 있었음
    'CF7100004': ('Ⅱ-1',
                  'Ⅱ. 투자활동으로 인한 현금흐름 > 1. 투자활동으로 인한 현금유입액', '+'),
    'CF7100005': ('Ⅱ-2',
                  'Ⅱ. 투자활동으로 인한 현금흐름 > 2. 투자활동으로 인한 현금유출액', '-'),
    'CF7100006': ('Ⅲ-1',
                  'Ⅲ. 재무활동으로 인한 현금흐름 > 1. 재무활동으로 인한 현금유입액', '+'),
    'CF7100007': ('Ⅲ-2',
                  'Ⅲ. 재무활동으로 인한 현금흐름 > 2. 재무활동으로 인한 현금유출액', '-'),
    # '사업결합으로 인한 순현금흐름' → Ⅱ-2 투자활동 현금유출액
    'CF4220003': ('Ⅱ-2',
                  'Ⅱ. 투자활동으로 인한 현금흐름 > 2. 투자활동으로 인한 현금유출액', '-'),
    # CF7100003 '기타 영업활동으로 인한 자산부채의 변동' 은 Ⅰ-4 가 정상이라 제외.
}
